...
filepath = '/home/jamal/Documents/support vector /Re%3a_Cyberbullying_dataset/text_train_5_df.csv'
col = ['TEXT_text_len','TEXT_percent_punctuation',	'TEXT_percent_uppercase',	'TEXT_text_sentiment',	'TEXT_percent_bad_words',	'TEXT_valence'	,'TEXT_arousal','TEXT_glove1',	'TEXT_glove2','TEXT_glove3' , 'id',	'bully']
