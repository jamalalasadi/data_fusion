...
filepath = '/home/jamal/Documents/support vector /Re%3a_Cyberbullying_dataset/visual_train_df_new.csv'
col = ['VISUAL_num_faces','VISUAL_valence','VISUAL_arousal','VISUAL_gore','VISUAL_explicit',	'VISUAL_drug','VISUAL_suggestive','VISUAL_ocr_len','VISUAL_labels1','VISUAL_labels2','VISUAL_labels3 ', 'id','bully']
...
filepath_test = '/home/jamal/Documents/support vector /Re%3a_Cyberbullying_dataset/visual_test_df_new.csv'
Data_test = pd.read_csv(filepath_test,delimiter = ',',names = col)
features_test = []
labels_test = []
for i in range(len(Data_test)):
    lst = Data_test.loc[i].tolist()
    features_test.append(lst[0:11])
    if lst[-1]=='bullying':
